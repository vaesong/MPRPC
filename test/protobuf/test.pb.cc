...
void UserServiceRpc::GetFriendsLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void UserServiceRpc_Stub::GetFriendsLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
