...
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendsRequest::_internal_userid() const {
  return userid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendsRequest::userid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendsRequest.userid)
  return _internal_userid();
}
inline void GetFriendsRequest::_internal_set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  userid_ = value;
}
inline void GetFriendsRequest::set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
